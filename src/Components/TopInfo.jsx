...
function TopInfo () {
    return(
        <div className="bg-gradient-to-br from-gray-300 to-gray-100 px-4 py-6 sm:flex sm:items-center sm:justify-between">
            ...
            <div className="mt-4 sm:mt-0 sm:flex sm:flex-row sm:justify-center">
                ...
                <div className="mt-4 sm:mt-0">
                    <h2 className="font-bold text-base sm:text-lg text-gray-800">Oriente</h2>
